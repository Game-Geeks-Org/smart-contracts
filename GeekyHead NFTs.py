## https://better-call.dev/jakartanet/KT1Wh51iphF9mAcH3AHuMsK4TXdmzvYtUzNu/operations
...
def add_test(config, is_default = True):
    ...
    def test():
        ...
        c1 = FA2(config = config,
                 metadata = sp.utils.metadata_of_url("ipfs://QmPwYsDSBXLAi1qh8usRQACko9WXVVKaKXpu4d3DXVZ4sP"),
                 admin = admin)
        scenario += c1
